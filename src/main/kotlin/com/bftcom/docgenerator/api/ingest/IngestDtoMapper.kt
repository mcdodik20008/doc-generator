...
object IngestDtoMapper {
    ...
    fun IngestRun.toDto(steps: List<IngestStep> = emptyList()): IngestRunDto = IngestRunDto(
        runId = id!!,
    ...
    fun IngestStep.toDto(): IngestStepDto = IngestStepDto(
        stepType = stepType,
        status = status,
    ...
    fun IngestEvent.toDto(): IngestEventDto = IngestEventDto(
        eventId = id!!,
        runId = run.id!!,
        stepType = stepType,
        level = level,
