...
class DocEvaluatorClient(
     ...
     */
    fun evaluateAsync(codeSnippet: String, generatedDoc: String): Mono<EvaluationResult> {
    ...
    fun evaluate(codeSnippet: String, generatedDoc: String): EvaluationResult? {
        return evaluateAsync(codeSnippet, generatedDoc).block()
    }
    ...
    fun healthCheck(): Boolean {
        return healthCheckAsync().block() ?: false
    }
}
