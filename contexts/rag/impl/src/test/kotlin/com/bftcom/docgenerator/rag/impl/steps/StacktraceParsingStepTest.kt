...
class StacktraceParsingStepTest {
    ...
    fun `parses simple stacktrace`() {
        ...
        val frames = result.context.getMetadata<List<*>>(QueryMetadataKeys.STACKTRACE_FRAMES)!!
        ...
        val appFrames = result.context.getMetadata<List<*>>(QueryMetadataKeys.STACKTRACE_APP_FRAMES)!!
            .filterIsInstance<StackFrame>()
